          ...
          <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-4">
            ...
            <div className="view-all-btn">
              <Link legacyBehavior href="/project">
                <a className="primary-btn3">View All Project</a>
              </Link>
            </div>
          </div>
        </div>
                  ...
                  <div className="success-storie-card">
                    <div className="success-img">
                      <img
                        ...
                        src="assets/img/home-3/home3-suc-sto-01.jpg"
                        alt=""
                      />
                    </div>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="success-storie-card">
                    <div className="success-img">
                      <img
                        className="img-fluid magnetic-item"
                        src="assets/img/home-3/home3-suc-sto-02.jpg"
                        alt=""
                      />
                    </div>
                    <div className="success-content">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="success-storie-card">
                    <div className="success-img">
                      <img
                        className="img-fluid magnetic-item"
                        src="assets/img/home-3/home3-suc-sto-03.jpg"
                        alt=""
                      />
                    </div>
                    <div className="success-content">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="success-storie-card">
                    <div className="success-img">
                      <img
                        className="img-fluid magnetic-item"
                        src="assets/img/home-3/home3-suc-sto-04.jpg"
                        alt=""
                      />
                    </div>
                    <div className="success-content">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="success-storie-card">
                    <div className="success-img">
                      <img
                        className="img-fluid magnetic-item"
                        src="assets/img/home-3/home3-suc-sto-05.png"
                        alt=""
                      />
                    </div>
                    <div className="success-content">
