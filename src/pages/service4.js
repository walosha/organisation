              ...
              <div className="single-solution">
                ...
                <div className="solution-content">
                  ...
                  <p>
                    ...
                    software programs that perform specific functions or tasks.
                  </p>
                </div>
                <div className="solution-btn-icon">
                  <div className="learn-btn">
                    ...
                    >
                      <g opacity="0.7" filter="url(#filter0_f_1886_20421)">
                        <circle
                          ...
                          cy={61}
                          r={23}
                          fill="url(#paint0_linear_1886_20421)"
                        />
                      </g>
                      <defs>
                        <filter
                          id="filter0_f_1886_20421"
                          x={0}
                          y={0}
                          width={122}
                          height={122}
            ...
            <div className="col-lg-4 col-lg-4 col-md-6 col-sm-10">
              <div className="single-solution">
                ...
                <div className="solution-content">
                  ...
                  <p>
                    Data analytics refers to the process of examining and
                    interpreting large datasets to extract insights and draw
                    conclusions.
                  </p>
                </div>
                <div className="solution-btn-icon">
                    ...
                    >
                      <g opacity="0.7" filter="url(#filter0_f_1886_20422)">
                        <circle
                          ...
                          cy={61}
                          r={23}
                          fill="url(#paint0_linear_1886_20422)"
                        />
                      </g>
                      <defs>
                        <filter
                          id="filter0_f_1886_20422"
                          x={0}
                          y={0}
                          width={122}
                          height={122}
              ...
              <div className="single-solution">
                ...
                <div className="solution-content">
                  ...
                  <p>
                    ...
                    technologies to promote products, services, or brands.
                  </p>
                </div>
                <div className="solution-btn-icon">
                  <div className="learn-btn">
                    ...
                    >
                      <g opacity="0.7" filter="url(#filter0_f_1886_20423)">
                        <circle
                          ...
                          cy={61}
                          r={23}
                          fill="url(#paint0_linear_1886_20423)"
                        />
                      </g>
                      <defs>
                        <filter
                          id="filter0_f_1886_20423"
                          x={0}
                          y={0}
                          width={122}
                          height={122}
